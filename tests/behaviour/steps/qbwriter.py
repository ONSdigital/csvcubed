    ...
    columns = [
        ...
        QbColumn(
            ...
            NewQbAttribute.from_data(
                ...
                "Some Attribute",
                data["Some Attribute"],
                [NewQbConcept("attr-a"), NewQbConcept("attr-c")],
            ),
        ),
        QbColumn(
            "Value",
    ...
    columns = [
        ...
        QbColumn(
            ...
            NewQbAttribute.from_data(
                ...
                [
                    NewQbConcept("final"),
                    NewQbConcept("in-review"),
                    NewQbConcept("pending"),
                ],
            ),
        ),
        QbColumn(
    ...
    columns = [
        ...
        QbColumn(
            ...
            NewQbAttribute.from_data(
                ...
                data["New Attribute"],
                [
                    NewQbConcept("university"),
                    NewQbConcept("students"),
                    NewQbConcept("masters"),
                ],
            ),
        ),
        QbColumn(

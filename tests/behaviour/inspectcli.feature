Feature: Behaviour testing of csvcubed inspect.
    ...
    Scenario: An older CSV-W generated by csvcubed build that uses the notation column as the identifier.
    ...
    Scenario: A newer CSV-W generated by csvcubed build that uses the uri identifier column as the identifier.

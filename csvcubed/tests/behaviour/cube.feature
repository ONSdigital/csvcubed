Feature: Cube!
  ...
  Scenario: Output a cube and errors when created from both config and data
    ...
    """
      [
        {"csv_column_title": "Dim-0", "structural_definition": {"label": "Non Dimension", "description": None, "code_list": {"metadata": {"title": "Non Dimension", "identifier": None, "summary": None, "description": None, "creator_uri": None, "publisher_uri": None, "landing_page_uris": [], "theme_uris": [], "keywords": [], "dataset_issued": None, "dataset_modified": None, "license_uri": None, "public_contact_point_uri": None, "uri_safe_identifier_override": None, }, "concepts": [{"label": "1", "code": "1", "parent_code": None, "sort_order": None, "description": None, "uri_safe_identifier_override": None}, {"label": "2", "code": "2", "parent_code": None, "sort_order": None, "description": None, "uri_safe_identifier_override": None}], "arbitrary_rdf": []}, "parent_dimension_uri": None, "source_uri": None, "range_uri": None, "uri_safe_identifier_override": None, "arbitrary_rdf": []}, "csv_column_uri_template": None, "uri_safe_identifier_override": None},
        {"csv_column_title": "Dim-1", "structural_definition": {"label": "Period Dimension", "description": None, "code_list": {"metadata": {"title": "Period Dimension", "identifier": None, "summary": None, "description": None, "creator_uri": None, "publisher_uri": None, "landing_page_uris": [], "theme_uris": [], "keywords": [], "dataset_issued": None, "dataset_modified": None, "license_uri": None, "public_contact_point_uri": None, "uri_safe_identifier_override": None, }, "concepts": [{"label": "2009", "code": "2009", "parent_code": None, "sort_order": None, "description": None, "uri_safe_identifier_override": None}, {"label": "2010", "code": "2010", "parent_code": None, "sort_order": None, "description": None, "uri_safe_identifier_override": None}], "arbitrary_rdf": []}, "parent_dimension_uri": None, "source_uri": None, "range_uri": None, "uri_safe_identifier_override": None, "arbitrary_rdf": []}, "csv_column_uri_template": None, "uri_safe_identifier_override": None},
  ...
  Scenario: Output a cube and errors when created data only
    ...
    """
      [
        ...
        {"csv_column_title": "Geography", "structural_definition": {"label": "Geography", "description": None, "code_list": {"metadata": {"title": "Geography", "identifier": None, "summary": None, "description": None, "creator_uri": None, "publisher_uri": None, "landing_page_uris": [], "theme_uris": [], "keywords": [], "dataset_issued": None, "dataset_modified": None, "license_uri": None, "public_contact_point_uri": None, "uri_safe_identifier_override": None, }, "concepts": [{"label": "London", "code": "london", "parent_code": None, "sort_order": None, "description": None, "uri_safe_identifier_override": None}], "arbitrary_rdf": []}, "parent_dimension_uri": None, "source_uri": None, "range_uri": None, "uri_safe_identifier_override": None, "arbitrary_rdf": []}, "csv_column_uri_template": None, "uri_safe_identifier_override": None},
        ...
        {"csv_column_title": "Attribute", "structural_definition": {"label": "Attribute", "description": None, "code_list": {"metadata": {"title": "Attribute", "identifier": None, "summary": None, "description": None, "creator_uri": None, "publisher_uri": None, "landing_page_uris": [], "theme_uris": [], "keywords": [], "dataset_issued": None, "dataset_modified": None, "license_uri": None, "public_contact_point_uri": None, "uri_safe_identifier_override": None, }, "concepts": [{"label": "Blue", "code": "blue", "parent_code": None, "sort_order": None, "description": None, "uri_safe_identifier_override": None}, {"label": "Green", "code": "green", "parent_code": None, "sort_order": None, "description": None, "uri_safe_identifier_override": None}, {"label": "Orange", "code": "orange", "parent_code": None, "sort_order": None, "description": None, "uri_safe_identifier_override": None}, {"label": "Red", "code": "red", "parent_code": None, "sort_order": None, "description": None, "uri_safe_identifier_override": None}], "arbitrary_rdf": []}, "parent_dimension_uri": None, "source_uri": None, "range_uri": None, "uri_safe_identifier_override": None, "arbitrary_rdf": []}, "csv_column_uri_template": None, "uri_safe_identifier_override": None},
      ]
    """
    ...
    Then The cube Metadata should match
      ...
      """
  # todo: This needs to be more robust to changes in structural definition data types.
#      Then The cube Columns should match
#      """
#      [
...
#        {"csv_column_title": "Dim-2", "structural_definition": {"label": "Dim-2", "description": None, "code_list": {"metadata": {"title": "Dim-2", "identifier": None, "summary": None, "description": None, "creator_uri": None, "publisher_uri": None, "landing_page_uris": [], "theme_uris": [], "keywords": [], "dataset_issued": None, "dataset_modified": None, "license_uri": None, "public_contact_point_uri": None, "uri_safe_identifier_override": None, }, "concepts": [{"label": "export", "code": "export", "parent_code": None, "sort_order": None, "description": None, "uri_safe_identifier_override": None}, {"label": "import", "code": "import", "parent_code": None, "sort_order": None, "description": None, "uri_safe_identifier_override": None}], "arbitrary_rdf": []}, "parent_dimension_uri": None, "source_uri": None, "range_uri": None, "uri_safe_identifier_override": None, "arbitrary_rdf": []}, "csv_column_uri_template": None, "uri_safe_identifier_override": None},
#        {"csv_column_title": "Attr-1", "structural_definition": {"label": "Attr-1", "description": None, "new_attribute_values": [{"label": "goods", "description": None, "uri_safe_identifier_override": None, "source_uri": None, "parent_attribute_value_uri": None, "arbitrary_rdf": []}, {"label": "services", "description": None, "uri_safe_identifier_override": None, "source_uri": None, "parent_attribute_value_uri": None, "arbitrary_rdf": []}], "parent_attribute_uri": None, "source_uri": None, "is_required": False, "uri_safe_identifier_override": None, "arbitrary_rdf": []}, "csv_column_uri_template": None, "uri_safe_identifier_override": None},
#        {"csv_column_title": "Amount", "structural_definition": {}, "csv_column_uri_template": None, "uri_safe_identifier_override": None},
#        {"csv_column_title": "Measure", "structural_definition": {"measures": [{"label": "Billions", "description": None, "parent_measure_uri": None, "source_uri": None, "uri_safe_identifier_override": None, "arbitrary_rdf": []}]}, "csv_column_uri_template": None, "uri_safe_identifier_override": None},
#        {"csv_column_title": "Units", "structural_definition": {"units": [{"label": "Pounds", "description": None, "source_uri": None, "uri_safe_identifier_override": None, "arbitrary_rdf": [], "base_unit": None, "base_unit_scaling_factor": None, "qudt_quantity_kind_uri": None, "si_base_unit_conversion_multiplier": None}]}, "csv_column_uri_template": None, "uri_safe_identifier_override": None}
#      ]
#      """
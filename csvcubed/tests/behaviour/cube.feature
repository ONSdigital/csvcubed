Feature: Cube!
  ...
  Scenario: Output a cube when the code list is defined using code list config schema v1.0 and when the concepts are hierarchical
    ...
    """
      [
          {'csv_column_title': 'Dimension', 'structural_definition': {'label': 'Dimension', 'description': None, 'code_list': {'metadata': {'title': 'Title of the code list', 'identifier': None, 'summary': 'Summary of the code list', 'description': 'Description of the code list', 'creator_uri': 'http://purl.org/dc/aboutdcmi#DCMI', 'publisher_uri': 'http://purl.org/dc/aboutdcmi#DCMI', 'landing_page_uris': [], 'theme_uris': ['http://example.com/themes/theme'], 'keywords': ['keyword1'], 'dataset_issued': '2022-03-31T12:54:30+00:00', 'dataset_modified': '2022-04-01T12:54:30+00:00', 'license_uri': 'https://creativecommons.org/licenses/by/4.0/', 'public_contact_point_uri': None, 'uri_safe_identifier_override': None}, 'concepts': [{'label': 'B', 'code': 'b', 'parent_code': None, 'sort_order': 0, 'description': 'B data record', 'uri_safe_identifier_override': None}, {'label': 'A', 'code': 'a', 'parent_code': None, 'sort_order': 1, 'description': 'A data record', 'uri_safe_identifier_override': None}, {'label': 'D', 'code': 'd', 'parent_code': 'b', 'sort_order': 0, 'description': 'D data record', 'uri_safe_identifier_override': None}, {'label': 'C', 'code': 'c', 'parent_code': 'b', 'sort_order': 1, 'description': 'C data record', 'uri_safe_identifier_override': None}, {'label': 'E', 'code': 'e', 'parent_code': 'd', 'sort_order': 0, 'description': 'E data record', 'uri_safe_identifier_override': None}], 'arbitrary_rdf': [], 'uri_style': None}, 'parent_dimension_uri': None, 'source_uri': None, 'range_uri': None, 'uri_safe_identifier_override': None, 'arbitrary_rdf': []}, 'csv_column_uri_template': None, 'uri_safe_identifier_override': None}, 

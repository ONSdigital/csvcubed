...
from csvcubed.utils.validators.uri import validate_uri, validate_uris_in_lists
...
class CatalogMetadata(CatalogMetadataBase, UriIdentifiable):
    ...
    _landing_page_uris_validator = validate_uris_in_lists("landing_page_uris", is_optional=True)

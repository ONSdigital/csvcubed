...
from csvcubedpmd.codelistcli.datetimecodelistgen import (
    _get_dimensions_to_generate_code_lists_for,
    _get_csv_columns_for_dimension,
...
HMRC_OTS_CN8_METADATA_JSON = (
    TEST_CASES_PATH / "hmrc-overseas-trade-statistics-cn8.csv-metadata.json"
)
HMRC_OTS_CN8_TIME_CODELIST = (
    "http://gss-data.org.uk/data/gss_data/trade/hmrc-overseas-trade-statistics/"
    "hmrc-overseas-trade-statistics-cn8#scheme/period"
)
HMRC_OTS_CN8_TIME_DIMENSION = (
    "http://gss-data.org.uk/data/gss_data/trade/hmrc-overseas-trade-statistics/"
...
def test_extracting_date_time_dimensions_from_metadata():
    date_time_dimensions = _get_dimensions_to_generate_code_lists_for(
        HMRC_OTS_CN8_METADATA_JSON
    )
...
def test_extracting_columns_for_dimension_from_metadata():
    columns = _get_csv_columns_for_dimension(
        HMRC_OTS_CN8_METADATA_JSON, HMRC_OTS_CN8_TIME_DIMENSION
    )

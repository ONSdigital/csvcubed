...
class CatalogMetadata(CatalogMetadataBase, UriIdentifiable):
    ...
    creator_uri: Optional[str] = field(default=None)
    publisher_uri: Optional[str] = field(default=None)
    landing_page_uris: list[str] = field(default_factory=list)
    theme_uris: list[str] = field(default_factory=list)
    keywords: list[str] = field(default_factory=list)
    dataset_issued: Union[datetime, date, None] = field(default=None)
    dataset_modified: Union[datetime, date, None] = field(default=None)
    license_uri: Optional[str] = field(default=None)
    public_contact_point_uri: Optional[str] = field(default=None)

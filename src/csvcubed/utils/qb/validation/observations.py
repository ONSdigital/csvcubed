...
from csvcubed.models.cube.qb.validationerrors import (
    BothMeasureTypesDefinedError, BothUnitTypesDefinedError,
    CsvColumnUriTemplateMissingError, EmptyQbMultiMeasureDimensionError,
    MoreThanOneMeasureColumnError, MoreThanOneObservationsColumnError,
    MoreThanOneUnitsColumnError, NoMeasuresDefinedError,
    NoObservedValuesColumnDefinedError, NoUnitsDefinedError)
...
def validate_observations(cube: Cube) -> List[ValidationError]:
    ...
    if num_obs_val_columns == 0:
        ...
        if len(standard_shape_obs_val_columns) == 1:
            ...
            obs_val_column = pivoted_obs_val_columns[0]
            errors += _validate_observation_value(obs_val_column, multi_units_columns)

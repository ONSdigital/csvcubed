...
def _get_unit_measure_col_for_standard_shape_cube(
    ...
    unit_col_retrived = get_unit_col_name_from_dsd(qube_components)
    ...
    measure_col_retrived = get_measure_col_name_from_dsd(qube_components)
...
def _melt_pivoted_shape(
    ...
    measure_components = _filter_components_from_dsd(
        qube_components,

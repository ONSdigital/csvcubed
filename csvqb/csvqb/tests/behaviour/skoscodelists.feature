Feature: Test outputting CSV-Ws containing `SKOS:ConceptScheme`s.
  ...
  Scenario: A basic code list can be serialised to a valid CSV-W described in SKOS.
    ...
    And the RDF should contain
      """
        <file:/tmp/basic-code-list.csv-metadata.json#scheme> a <http://www.w3.org/2004/02/skos/core#ConceptScheme>,
        ...
        <file:/tmp/basic-code-list.csv#concept/second-concept> <http://www.w3.org/2000/01/rdf-schema#label>
            "Second Concept";
          <http://www.w3.org/2004/02/skos/core#broader> <file:/tmp/basic-code-list.csv#concept/1st-concept>;
          <http://www.w3.org/2004/02/skos/core#inScheme> <file:/tmp/basic-code-list.csv#scheme>;

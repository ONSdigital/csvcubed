...
#### Inspecting a single-unit multi-measure data cube
...
#### Inspecting a code list with hierarchical depth of one
...
#### Inspecting a code list with hierarchical depth of more than one

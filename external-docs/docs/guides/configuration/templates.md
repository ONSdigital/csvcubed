...
| [mixed-period](https://purl.org/csv-cubed/qube-config/templates/mixed-period.json)                 | Template allows the definition of mixed time periods within one dimension, e.g. 2020-Q4 (quarter), 2021-06 (month), 2019-08-06 (day) | See Description     |

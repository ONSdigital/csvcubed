...
it will be [configured by convention](../../convention.md). This means that your column will be
...
`http://example.org/some-uri/{+column_name}`), as this will ensure that the URIs generated by csvcubed as cell values are consistent with the [column names that are generated](../../../uris.md).

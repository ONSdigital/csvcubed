...
| `code_list`         | Link to an existing code list (uri), supress a code-list (false), path to a [code-list-config.json](code-list-config.md) (uri), or generate a code-list (true) | true                                                                             |
